...
class Patient(BaseModel):
    ...
    preexisting_conditions: Optional[List[str]] = Field(default=[], description="List of preexisting medical conditions")
    medications: Optional[List[str]] = Field(default=[], description="List of current medications")
    family_history: Optional[List[str]] = Field(default=[], description="Family medical history")
...
async def process_patient_data(
    ...
    try:
        ...
        patient_data = Patient(
            ...
            preexisting_conditions=json.loads(preexisting_conditions),
            medications=json.loads(medications),
            family_history=json.loads(family_history),
            question=question,
